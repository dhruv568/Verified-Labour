    ...
    return (
      <div className={`w-full ${className}`}>
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 text-sm font-semibold rounded-lg border border-slate-200 bg-slate-50 text-slate-800"
        >
        ...
        {isOpen && (
          <div className="mt-2 p-3 bg-white rounded-xl border border-slate-200 shadow-lg space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-2.5 px-3 bg-brand-50 hover:bg-brand-100 border border-brand-200 text-brand-800 font-bold text-xs rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
            >
              {isLoading ? (
                <>
              ...
              <div className="flex gap-1.5">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-2.5 py-1.5 text-xs rounded-lg border border-slate-300 focus:ring-1 focus:ring-brand-500 outline-none"
                  />
                </div>
                <button
                  type="submit"
                  disabled={manualLoading || !searchQuery.trim()}
                  className="px-3 py-1.5 bg-navy-800 text-white font-bold text-xs rounded-lg hover:bg-navy-900 disabled:opacity-50"
                >
