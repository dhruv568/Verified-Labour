    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Brand Logo with Helmet & Verified Badge */}
          <Link href="/" className="flex items-center gap-2.5 group shrink-0">
            <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-amber-400 text-navy-950 shadow-xs">
              ...
              <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-0.5 shadow-xs">
                <CheckCircle2 className="w-4 h-4 text-[#0B9B5A] fill-[#0B9B5A] text-white" />
              </div>
            </div>
          ...
          <div className="lg:hidden py-4 border-t border-slate-100 space-y-3 animate-in fade-in duration-150">
            ...
            <nav className="space-y-1 px-1">
              <Link
                ...
                className="block px-3 py-2 text-sm font-bold text-[#0F2A5F] hover:bg-slate-50 rounded-xl"
              >
                Home
              </Link>
              <a
              ...
              <button
                ...
                className="w-full text-left block px-3 py-2 text-sm font-bold text-[#0B9B5A] hover:bg-brand-50/50 rounded-xl"
              >
                Become a Worker
              </button>
              <a
              ...
              {sessionUser ? (
                <div className="space-y-2">
                  <Link
                    href={getDashboardLink()}
                    onClick={() => setMobileMenuOpen(false)}
                    className="block w-full text-center px-4 py-2.5 bg-[#0F2A5F] text-white font-bold rounded-xl shadow-xs text-xs"
                  >
                  ...
                  <button
                    ...
                    className="block w-full text-center px-4 py-2 text-red-600 font-semibold text-xs hover:bg-red-50 rounded-xl"
                  >
                    Log Out
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-center font-bold text-white bg-[#0B9B5A] hover:bg-[#08783b] rounded-full text-xs shadow-xs transition-colors"
                  >
                    Login
                  </button>
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-center font-bold text-white bg-[#1464D2] hover:bg-blue-700 rounded-full text-xs shadow-xs transition-colors"
                  >
                    Sign Up
                  </button>
                </div>
