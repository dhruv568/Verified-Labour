...
export default function Footer() {
  return (
    <footer className="bg-white text-slate-600 pt-16 pb-8 border-t border-slate-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 xl:gap-10 pb-12 border-b border-slate-200">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-amber-400 text-navy-950 shadow-xs">
                ...
                <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-0.5 shadow-xs">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#0B9B5A] fill-[#0B9B5A] text-white" />
                </div>
              </div>
              <div className="flex flex-col">
                <div className="flex items-center text-xl font-black tracking-tight leading-none">
                  <span className="text-[#0F2A5F]">Verified</span>
                  <span className="text-[#0B9B5A] ml-1">Labour</span>
                </div>
          ...
          <div>
            <h4 className="text-xs font-bold text-[#0F2A5F] uppercase tracking-wider mb-4">
              Quick Links
            </h4>
            <ul className="space-y-2.5 text-xs font-semibold text-slate-600">
              <li>
                <Link href="/" className="hover:text-[#1464D2] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <a href="/#workers" className="hover:text-[#1464D2] transition-colors">
                  Find a Worker
                </a>
              </li>
              <li>
                <Link href="/worker/onboarding" className="hover:text-[#0B9B5A] transition-colors">
                  Become a Worker
                </Link>
              </li>
              <li>
                <a href="/#how" className="hover:text-[#1464D2] transition-colors">
                  How It Works
                </a>
              </li>
              <li>
                <Link href="/business/bulk" className="hover:text-[#1464D2] transition-colors">
                  Bulk Labour Portal
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs font-semibold text-slate-600">
              <li>
                <Link href="/legal/terms" className="hover:text-[#1464D2] transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/legal/privacy" className="hover:text-[#1464D2] transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/legal/cancellation-refund" className="hover:text-[#1464D2] transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/legal/verification" className="hover:text-[#1464D2] transition-colors">
                  Aadhaar Verification Policy
                </Link>
              </li>
              <li>
                <Link href="/legal/safety" className="hover:text-[#1464D2] transition-colors">
                  Grievance Redressal
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-4 pt-3 text-xs text-slate-500 space-y-1">
              ...
              <p className="text-[11px]">support@verifiedlabour.com</p>
              <p className="text-[11px]">+91 99999 99999</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              {/* Google Play Button */}
              <div className="bg-black text-white px-3.5 py-2 rounded-xl flex items-center gap-2.5 border border-slate-800 shadow-xs cursor-pointer hover:bg-slate-900 transition-colors w-fit">
                ...
                <div className="text-left">
                  <span className="text-[9px] uppercase tracking-wider block font-semibold text-slate-400 leading-none">
                    Get it on
                  </span>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-3 font-medium">
