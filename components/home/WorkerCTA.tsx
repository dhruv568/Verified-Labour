...
export default function WorkerCTA({ onRegisterWorker }: WorkerCTAProps) {
  ...
  return (
    <div className="bg-[#079447] rounded-3xl p-5 sm:p-8 text-white shadow-xl relative overflow-hidden flex flex-col justify-between min-h-[380px] sm:min-h-[420px] lg:min-h-[440px]">
      ...
      {/* Soft Solid Green Gradient Overlays - Keeps text area solid while revealing image clearly on right */}
      <div className="absolute inset-y-0 left-0 w-[68%] sm:w-[56%] bg-gradient-to-r from-[#079447] via-[#079447] via-55% to-transparent pointer-events-none z-10" />
