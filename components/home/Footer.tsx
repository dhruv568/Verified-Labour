    ...
    <footer className="bg-white text-slate-600 pt-14 pb-8 border-t border-slate-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 xl:gap-10 pb-10 border-b border-slate-200">
          ...
          {/* Col 2: Quick Links */}
          <div>
            <h4 className="text-xs font-bold text-[#082B66] uppercase tracking-wider mb-3">
              Quick Links
            </h4>
            <ul className="space-y-2 text-sm sm:text-xs font-semibold text-slate-600">
              <li>
                <Link href="/" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <a href="/#workers" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Find a Worker
                </a>
              </li>
              <li>
                <Link href="/worker/onboarding" className="inline-block py-1 hover:text-[#079447] transition-colors">
                  Become a Worker
                </Link>
              </li>
              <li>
                <a href="/#how" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  How It Works
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-xs font-semibold text-slate-600">
              <li>
                <Link href="/legal/safety" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <a href="#contact" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Contact Us
                </a>
              </li>
              <li>
                <Link href="/legal/terms" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/legal/privacy" className="inline-block py-1 hover:text-[#1264D6] transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
