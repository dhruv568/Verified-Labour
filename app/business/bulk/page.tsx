  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full flex-1">
        {/* Banner */}
        <div className="bg-navy-900 rounded-3xl p-8 sm:p-10 text-white shadow-xl mb-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 border border-navy-800">
          ...
          <button
            ...
            className="px-6 py-3.5 bg-amber-500 hover:bg-amber-600 text-navy-950 font-black text-xs rounded-xl shadow-lg transition-all flex items-center gap-2 shrink-0"
          >
        ...
        <div className="space-y-6">
          ...
          {loading ? (
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs pt-3 border-t border-slate-100 text-slate-600">
                      ...
                      <span className="flex items-center gap-1.5 font-medium col-span-2">
                  ...
                  <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 bg-brand-700 hover:bg-brand-800 text-white font-bold text-xs rounded-xl shadow-xs transition-colors"
                    >
                      Apply as Worker →
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-12 text-center">
              ...
              <button
                onClick={() => setShowPostModal(true)}
                className="mt-3 px-4 py-2 bg-brand-700 text-white font-bold text-xs rounded-xl"
              >
        ...
        {showPostModal && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4">
              ...
              <form onSubmit={handlePostRequirement} className="space-y-3">
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-slate-300 text-xs outline-none resize-none"
                  />
                </div>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 py-2.5 bg-brand-700 text-white font-bold text-xs rounded-xl shadow-md"
                  >
